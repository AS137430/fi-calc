    ...
    return (
      <div className="standardPage">
        ...
        <p className="appParagraph">
          ...
          Modifications made to the Service's source code, which is available
          under the MIT License, must not be affiliated with the Service.
        </p>
        <p className="appParagraph">
        ...
        <p className="appParagraph">
          FI Calc is a constantly changing Service. We may add and remove
          functionality, or suspend and stop the Service altogether.
        </p>
        <h2 className="secondaryHeader">Your Data in the Services</h2>
        <p className="appParagraph">
          FI Calc does not store any data that you provide to it.
        </p>
        <p className="appParagraph">
          Should this change, we hold the right to remove any data that is
          stored within this Service.
        </p>
        <h2 className="secondaryHeader">Liability for our Services</h2>
        <p className="appParagraph">
          When permitted by law, FI Calc shall not be responsible for direct,
          indirect, incidental, special, consequential or exemplary damages
          resulting from your use of the Service. This covers, but is not
          limited to, any data or information stored in FI Calc.
        </p>
        ...
        <p className="appParagraph">
          ...
          also accepts these terms. It shall defend FI Calc from any third-party
