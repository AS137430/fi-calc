        ...
        {inputs.withdrawalStrategyName.value === 'dynamicSwr' && (
          <>
            <p>
              ...
              given year is determined by the remaining balance of your
              retirement savings, life expectancy, and market expectations. As
              your life expectancy wanes, the withdrawal rate increases such
              that not much is left behind.
            </p>
            <p>
              The equation for the Dynamic SWR withdrawal method is as follows:
            </p>
            <code>
              withdrawalAmount = portfolioTotalValue * (roiAssumption -
              inflationAssumption) / (1 - Math.pow((1 + inflationAssumption) /
              (1 + roiAssumption), yearsRemaining + 1));
            </code>
            <p>
              Their official{' '}
              <a href="https://www.nesteggly.com/dynamic-safe-withdrawal-rate-calculator">
                calculator
              </a>{' '}
              can factor in pensions and social security to provide a more
              smooth income stream throughout retirement.
            </p>
            <p>
              Read more about Dynamic SWR{' '}
              <a href="https://www.nesteggly.com/blog/dynamic-swr-explained">
                here
              </a>
              .
            </p>
